                                            ...
                                            <div class="card-body">
                                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy3455 = "SELECT * FROM messages_seller_to_buyer where buyeremail='$sellerz_emailz' ORDER BY id DESC";
                                                        $isellerrank = 0;
                                                        ...
                                                        foreach ($query455 as $value45) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="selernn<?php echo $value45['id']; ?>"><?php echo $value45['sellername']; ?></td>
                                                                <td id="seleremm<?php echo $value45['id']; ?>"><?php echo $value45['selleremail']; ?></td>
                                                                <td><?php echo $value45['messagez']; ?></td>
                                                                <td><?php echo $value45['datez']; ?></td>
                                                                <td><?php echo $value45['timez']; ?></td>
                                                                <td><button class="btn btn-info" onclick="buyerrmeszz(<?php echo $value45['id']; ?>)">Send reply</button></td>
                                                                <?php
                                                                if ($value45['status'] == "notread") {
                                                                    ?>
                                                                    <td><button class="btn btn-success" onclick="messagemarkasreadbuyer(<?php echo $value45['id']; ?>)">Mark as read</button></td>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <td></td>   
                                                ...
                                                <center>
                                                    <a href="buyerOutbox.php" >View Sent box</a>
                                                </center>
                                            </div>
                                        </div>
                                    </div>
